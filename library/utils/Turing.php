...
class Turing{
	...
	private $fontFile = 'fonts/cambria.png';
	...
	private $fluctuationAmplitude = 0.2;
	...
	public static function generate($width = 90, $height = 55, $fontFile = 'fonts/antiqua.png', $jpegQuality = 100, $mime = "jpg"){
		 if(self::$instance == null)
		 	self::$instance = new Turing($width, $height, $fontFile, $jpegQuality, $mime);
